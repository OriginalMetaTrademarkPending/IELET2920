...
sol_timeframe(:, 1) = m0';
for i = 2:N
    part_sol = ode45(@(t,m)diff_eq_cramp(t, m, theta_real, u(i)), [tspan(i-1), tspan(i)], sol_timeframe(:, i-1));
...
theta = optimvar('theta', 7, 'LowerBound', [0, 0, 0, 0, 0, 0, 0]);
